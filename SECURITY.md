...
3. **Response expectations:**  
   ...
   - We will provide updates on the investigation at least once per week until resolution.  
   - If the vulnerability is confirmed, we will work on a fix and coordinate a release.  
   - If the vulnerability is declined (e.g., not reproducible or out of scope), we will explain why.
